...
import static com.gamgyul_code.halmang_vision.global.exception.ErrorCode.FILE_SIZE_EXCEEDED;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(HalmangVisionException.class)
    public ResponseEntity<ErrorResponse> handleHalmangVisionException(HalmangVisionException e) {
